...
mongoose
  ...
  .then(() => console.log("DB connected"));//https://github.com/Automattic/mongoose/issues/5237
  //atlas mongodb connection error closed --- request for google search
...
// console.log("------------>", 1)
// const uri = "mongodb+srv://admin:57ntCDyc6TXGtG1D@myfirstcluster-ko37b.mongodb.net/test?retryWrites=true";
// console.log("------------>", 2)
